...
File.readlines('deploy/filenames.diff').each do |line|
  ...
  # Complete filename version, i.e.: https://bfa-prepatch.herodamage.com/blog/index.html
  urls.push("#{baseUrl}/#{relativeUrl}")
  # Extensionless filename version for html files, i.e.: https://bfa-prepatch.herodamage.com/blog/index
  if relativeUrl.include? '.html'
    urls.push("#{baseUrl}/#{relativeUrl.gsub(".html", '')}")
  end
  # Indexless version, i.e.: https://bfa-prepatch.herodamage.com/blog/
  if relativeUrl.include? 'index.html'
    urls.push("#{baseUrl}/#{relativeUrl.gsub("index.html", '')}")
  end
  # Indexless version without trailing slash, i.e.: https://bfa-prepatch.herodamage.com/blog
  if relativeUrl.include? '/index.html'
    urls.push("#{baseUrl}/#{relativeUrl.gsub("/index.html", '')}")
  end
